...
\begin{frame}
    ...
    \begin{itemize}
        \item On Spring 2023 I helped in the discussion sessions of the
            Neuroinformatics course by Prof.~Ken Harris, for UCL undegraduate
        ...
        \item On 2025 we renamed the course \emph{Statistical Neuroscience} and
            to teach all lectures ourselves. We invited lecturers and students
...
\frametitle{A few of our motivations to run this course}
    ...
    \begin{enumerate}
        \item Enjoy learning by teaching.
...
\begin{frame}
    ...
    \begin{description}
        ...
        \item[Lectures]: Monday 1-3pm, SWC lecture theathre.

        \item[Practicals]: Friday 2-3:30pm, SWC lecture theathre.

        \item[Office Hours]: Joaquin, Wednesday 4-5pm, or by an arranged appointment.

        \item[Worksheet]: assigned on Mondays, due on the following Monday
            before 1pm. Workshees by SWC PhD students will be graded. Solutions
...
\begin{frame}
    ...
    \begin{exampleblock}{Example (Mean function of the autoregressive model of
        ...
        An AR(1) model (Eq.~\ref{eq:ar1}) can be represented as a moving average of infinite order MA($\infty$).
...
\begin{frame}
    ...
    \begin{exampleblock}{Example (Forecasting with an AR(p) model)}
        ...
        \begin{center}
            \href{http://www.gatsby.ucl.ac.uk/~rapela/statNeuro/2025/lectures/01_temporalTimeSeriesAnalysis/figures/forecastingAR7.html}{\includegraphics[width=2.00in]{../../../mySolutions/01_temporalTimeSeriesAnalysis/figures/forecastingAR7.png}}
        \end{center}
    \end{exampleblock}
\end{frame}
