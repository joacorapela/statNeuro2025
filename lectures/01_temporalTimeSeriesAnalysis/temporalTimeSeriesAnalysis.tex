...
\begin{frame}
    ...
    \begin{exampleblock}{Example (Forecasting with an AR(p) model)}
        ...
        \begin{center}
            \href{http://www.gatsby.ucl.ac.uk/~rapela/statNeuro/2025/lectures/01_temporalTimeSeriesAnalysis/figures/autoregressiveAutoCovN100.html}{\includegraphics[width=2.00in]{../../../mySolutions/01_temporalTimeSeriesAnalysis/figures/forecastingAR7.png}}
        \end{center}
    \end{exampleblock}
\end{frame}
