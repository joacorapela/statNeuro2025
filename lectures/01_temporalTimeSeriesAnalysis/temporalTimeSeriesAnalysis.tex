...
\begin{frame}
    ...
    \href{https://joacorapela.github.io/statNeuro2025/auto\_examples/01\_temporalTimeSeriesAnalysis/plot\_whiteNoiseAutocovariance.html\#\#sphx-glr-auto-examples-01-temporaltimeseriesanalysis-plot-whitenoiseautocovariance-py}{Solution}.

    \begin{center}
        \href{http://www.gatsby.ucl.ac.uk/~rapela/statNeuro/2025/lectures/01_temporalTimeSeriesAnalysis/figures/movingAverageAutoCorN100.html}{\includegraphics[width=2.00in]{../../examples/sphinx_gallery/01_temporalTimeSeriesAnalysis/figures/whiteNoiseAutoCorN100.png}}
        \href{http://www.gatsby.ucl.ac.uk/~rapela/statNeuro/2025/lectures/01_temporalTimeSeriesAnalysis/figures/movingAverageAutoCorN10000.html}{\includegraphics[width=2.00in]{../../examples/sphinx_gallery/01_temporalTimeSeriesAnalysis/figures/whiteNoiseAutoCorN10000.png}}
    \end{center}
...
\begin{frame}
    ...
    \begin{align*}
        ...
        % \text{var}(\text{Pred}(X_{n+h}|X_n,\ldots,X_{n-(m-1)}))=\gamma(0)-\mathbf{a_m}^\intercal\left[\begin{array}{c}
        %                                                                                       \gamma(h)\\
        %                                                                                       \vdots\\
        %                                                                                       \gamma(h+(m-1))
        %                                                                                     \end{array}\right]
    \end{align*}
    %
    % The goal of forecasting is to find the coefficients $a_0,\ldots,a_{m-1}$ of the
    % linear combination of $1,X_n,\ldots,X_{n-(m-1)}$ that forecasts $X_{n+h}$ with
    ...
    % \small
    % \begin{align*}
    %     a^*_0,\ldots,a^*_{m-1}=\argmin_{a_0,\ldots,a_{m-1}}E\left\{\left(X_{n+h}-\left(a_0X_n+a_1X_{n-1}+\ldots+a_{m-1}X_{n-(m-1)}\right)\right)^2\right\}
    % \end{align*}
    % \normalsize
